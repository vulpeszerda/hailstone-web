	...
	Client.prototype = {
		install : function () {
			...
			this.canvas.addEventListener('mousemove', function (e) {
				...
				self.socket.emit('mouse', e.clientX - offset.left, e.clientY - offset.top, 0, isMouseDown);
			...
			this.canvas.addEventListener('contextmenu', function (e) {
				...
				var offset = Mstsc.elementOffset(self.canvas);
				self.socket.emit('mouse', e.clientX - offset.left, e.clientY - offset.top, mouseButtonMap(e.button), isMouseDown);
				e.preventDefault();
				return false;
			});
